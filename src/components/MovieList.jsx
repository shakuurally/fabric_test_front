...
const MovieList = ({ data, loading }) => {
  ...
  useEffect(() => {
    if (!loading) {
      // Animate the grid items with a stagger effect
            ...
            data.map((movie, index) => (
              <>
                <motion.div
                  ...
                  animate={controls} // Animation state (controls)
                  transition={{ duration: 1, delay: index * 0.1 }} // Animation duration with staggered delay
                    ...
                    <div class="shadow p-4 rounded-lg bg-white">
                      <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                        <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                          <div class="absolute inset-0 bg-black hover:opacity-80 opacity-100">
                      ...
                      <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                        <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                          ...
                          <span class="mt-2 xl:mt-0">{movie.Type}</span>
                        </p>
                        <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                          <svg
                            class="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                          ...
                          <span class="mt-2 xl:mt-0">{movie.imdbID}</span>
                        </p>
                      </div>
